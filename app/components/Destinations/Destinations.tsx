  ...
  const destinations: Destination[] = [
    {
      ...
      title: t("home.destinations.paris.title"),
      description: t("home.destinations.paris.description"),
      link: t("home.destinations.paris.link"),
    },
    {
      ...
      title: t("home.destinations.tokyo.title"),
      description: t("home.destinations.tokyo.description"),
      link: t("home.destinations.tokyo.link"),
    },
    {
      ...
      title: t("home.destinations.nyc.title"),
      description: t("home.destinations.nyc.description"),
      link: t("home.destinations.nyc.link"),
    },
    {
      ...
      title: t("home.destinations.mexico.title"),
      description: t("home.destinations.mexico.description"),
      link: t("home.destinations.mexico.link"),
    },
    {
      ...
      title: t("home.destinations.london.title"),
      description: t("home.destinations.london.description"),
      link: t("home.destinations.london.link"),
    },
    {
      ...
      title: t("home.destinations.prague.title"),
      description: t("home.destinations.prague.description"),
      link: t("home.destinations.prague.link"),
    },
  ];
