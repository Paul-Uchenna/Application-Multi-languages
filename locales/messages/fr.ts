export default {
  home: {
    ...
    hero: {
      ...
      subtitle: "Voyagez à travers les plus belles destinations",
    ...
    destinations: {
      ...
      tokyo: {
        title: "Tokyo",
        description: "Là où tradition rencontre modernité",
        link: "En savoir plus",
      },
      nyc: {
        title: "New York",
      ...
      mexico: {
        title: "Mexico",
        description: "Le pays des Aztèques et du soleil",
        link: "En savoir plus",
      },
      london: {
        title: "Londres",
        description: "La ville de la reine",
        link: "En savoir plus",
      },
      prague: {
        title: "Prague",
        description: "La ville aux cent clochers",
        link: "En savoir plus",
      },
    },
    blogs: {
      ...
      quality: {
        ...
        description: "Le meilleur service garanti",
      },
      support: {
        title: "Support 24/7",
    ...
    cta: {
      title: "Prêt à Partir ?",
      subtitle: "Réservez votre prochaine aventure dès maintenant",
      button: "Réserver",
    },
  },
  destinations: {
    ...
    countryId: {
      titleOne: "Informations générales",
      titleTwo: "Localisation géographique",
      countryInfo: {
        capital: "Capitale",
        region: "Région",
      ...
      weather: {
        error:
          "Impossible de charger les données météorologiques. Veuillez réessayer plus tard.",
        temperature: "Température",
        feelsLike: "Ressemble à",
        humidity: "Humidité",
      ...
      PhotoGallery: {
        noPhotos: "Aucune photo disponible pour",
        title: "Photos des lieux à visiter en",
      },
    },
  },
  blog: {
